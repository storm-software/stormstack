            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("v1", new OpenApiInfo
                    {
                        Version = "v1",
                        Title = "User APIs",
                        Description = "User APIs (ASP.NET Core 7.0)",
                        TermsOfService = new Uri("https://sullivanpj.github.io/open-system/services/users"),
                        Contact = new OpenApiContact
                        {
                            Name = "Patrick Sullivan",
                            Url = new Uri("https://sullivanpj.github.io/open-system/services/users"),
