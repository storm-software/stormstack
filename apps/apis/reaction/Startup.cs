...
namespace OpenSystem.Apis.Reaction
{
    /// <summary>
    /// Startup
    /// </summary>
    ...
    {
        private const string SERVICE_NAME = "ReactionService.Api";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    {
                        Title = "Reaction",
                        Description = "Reaction (ASP.NET Core 7.0)",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                {
                    c.RouteTemplate = "/api/v1.0/{documentName}/openapi-original.json";
                })
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/api/v1.0/openapi-original.json", "Reaction");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "Reaction Original");
                });
            app.UseRouting();
            app.UseStaticFiles();
