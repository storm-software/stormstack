...
namespace OpenSystem.Apis.Reaction.Controllers
{
    /// <summary>
    ...
    public sealed class ReactionApiController : ControllerBase
    {
        ...
        [SwaggerResponse(statusCode: 500, type: typeof(ProblemDetailsDto), description: "Internal Server Error")]
        [SwaggerResponse(statusCode: 503, type: typeof(ProblemDetailsDto), description: "Service Unavailable")]
        public async Task<ActionResult<GetReactions200ResponseDto>> GetReactions([FromRoute (Name = "id")][Required]string id, [FromHeader][Required()]string userId)
        {
            ...
            // return StatusCode(503, default(ProblemDetailsDto));
            string exampleJson = null;
            exampleJson = "{\"Guid\": \"123e4567-e89b-12d3-a456-426614174000\", \"CreatedOn\": \"2022-03-19T04:24:02.190\", \"CreatedBy\": \"PSUL\", \"UpdatedOn\": \"2022-10-12T14:01:13.000\", \"UpdatedBy\": \"PSUL\", \"ArticleId\": \"home\", \"Reactions\": [{ \"Type\": \"LIKE\", \"Count\": 548 }]}";
            ...
            //TODO: Change the data returned
            return await Task.FromResult<ActionResult<GetReactions200ResponseDto>>(new ObjectResult(example));
        }
    }
}
