...
using OpenSystem.Contact.Infrastructure;
...
try
{
    ...
    builder.Services.AddContactApplicationLayer();
    builder.Services.AddContactPersistenceInfrastructure(builder.Configuration);
