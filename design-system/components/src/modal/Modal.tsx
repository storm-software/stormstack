      ...
      <div
        ...
        {showCloseIcon && onClose && (
          <div
            onClick={onClose}
            className={clsx(
              "absolute right-1 top-1 z-40 mx-2.5 my-2 cursor-pointer rounded-full border-2 p-3 font-semibold transition-colors",
        ...
        <div className="flex h-full flex-col gap-5">
          ...
          {typeof children === "string" ? (
            <div className="font-body-1 font-bold text-body-1">{children}</div>
          ) : (
            children
          )}
        </div>
