...
import { ModalReference, ModalVariants } from "./Modal.types";
import {
  getBackgroundStyle,
  getBorderStyle,
  getCloseButtonStyle,
    ...
    return (
      <AnimatePresence>
        {opened && (
          <motion.div
            className={clsx(
              "relative z-20 h-[30rem] min-h-fit w-[55rem] border-4 p-6 shadow-xl backdrop-blur-sm backdrop-brightness-0",
            ...
            <div className="flex h-full flex-col gap-5">
              ...
              {typeof children === "string" ? (
                <div className="font-body-1 font-bold text-primary">
                  {children}
                </div>
              ) : (
                children
