...
- [🛠️ Cloudflare Workers - Nx Tools](#️-cloudflare-workers---nx-tools)
...
Run `nx test tools-nx-cloudflare` to execute the unit tests via [Jest](https://jestjs.io).
