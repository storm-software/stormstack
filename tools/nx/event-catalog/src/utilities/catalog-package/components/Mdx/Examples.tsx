      ...
      <div className="">
        ...
        <div>
          <div className="col-span-5">
            <nav
              className="-mb-2 w-full bg-gray-900 flex overflow-hidden overflow-x-scroll"
              aria-label="Tabs">
              {tabs.map(tab => {
                ...
                return (
                  <button
                    ...
                    className={classNames(
                      ...
                      "important:no-underline border-b-2 px-6 py-3 text-xs font-medium transition  whitespace-nowrap "
                    )}
