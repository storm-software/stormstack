...
function NodeGraphBuilder({
  ...
  return (
    <ReactFlow
      ...
      maxZoom={maxZoom}>
      {title && (
        <div className="right-4 top-4 z-10 space-x-2 bg-white px-4 py-2 text-lg absolute">
      ...
      <Controls className="react-flow__controls-no-shadow top-5 absolute block" />
...
function NodeGraph({
  ...
  return (
    <div
      ...
      <Link
        className="mt-4 text-xs  block text-right underline"
