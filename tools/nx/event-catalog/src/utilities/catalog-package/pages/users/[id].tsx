      ...
      <div className="flex-1 ">
        <div className="py-8 xl:py-10">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 xl:grid xl:max-w-7xl xl:grid-cols-4">
            <div className="min-h-screen xl:col-span-3 xl:border-r xl:border-gray-200 xl:pr-8">
              ...
              {events.length > 0 && (
                <div className="border-b border-gray-100 pb-6">
                  <h1 className="mt-4 text-lg font-bold text-gray-800 relative">
            ...
            <div className="px-8">
              <div className="mt-4 space-x-5 flex items-center ">
                <div className="flex-shrink-0">
                  <div className="relative">
                    ...
                    />
                    <span
                      className="inset-0 rounded-full shadow-inner absolute"
                      aria-hidden="true"
                    />
                  </div>
                </div>
              ...
              <div className="mt-6 border-t border-gray-200 py-6 text-sm flow-root">
                {user.summary}
              </div>
            </div>
          </div>
