 ...
 * 1) Set a break point in OpenSystemTypeScriptReduxGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class OpenSystemTypeScriptReduxGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("open-system-typescript-redux") // use this codegen library
              ...
              .setOutputDir("out-test/test") // output directory
                ...
                .addAdditionalProperty("useInversify", "false");
