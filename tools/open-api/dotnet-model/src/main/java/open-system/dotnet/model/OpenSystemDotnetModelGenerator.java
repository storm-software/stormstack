...
public class OpenSystemDotnetModelGenerator extends AbstractCSharpCodegen {
    ...
    protected final Logger LOGGER = LoggerFactory.getLogger(OpenSystemDotnetModelGenerator.class);
    ...
    private CliOption classModifier = new CliOption(CLASS_MODIFIER, "Class Modifier for Model classes: Empty string or abstract.");
   ...
   private String dockerTag = null;
    ...
    public OpenSystemDotnetModelGenerator() {
        super();
        ...
        apiTemplateFiles.put("request.mustache", ".cs");
    ...
    public String getName() {
        return "open-system-dotnet-model";
    }
    ...
    public String templateDir() {
        return "C:\\Development\\open-system\\tools\\openapi\\dotnet-model\\src\\main\\resources\\open-system-dotnet-model";
    }
    ...
    public void processOpts() {
        ...
        if (!additionalProperties.containsKey(CodegenConstants.API_PACKAGE)) {
            apiPackage = packageName + ".Models";
            additionalProperties.put(CodegenConstants.API_PACKAGE, apiPackage);
        }

        if (!additionalProperties.containsKey(CodegenConstants.MODEL_PACKAGE)) {
            modelPackage = packageName + ".Models.DTOs";
    ...
    public String modelFileFolder() {
        return outputFolder + File.separator + "Models" + File.separator + "DTOs" + File.separator;
    }
    ...
    private void addProducesInfo(ApiResponse inputResponse,
      OpenSystemDotnetModelCodegenOperation codegenOperation) {
     ...
     */
    @Override
    public OpenSystemDotnetModelCodegenOperation fromOperation(String path,
      String httpMethod,
      Operation operation,
      List<Server> servers) {
        ...
        OpenSystemDotnetModelCodegenOperation op = OpenSystemDotnetModelCodegenModelFactory.newInstance(OpenSystemDotnetModelCodegenModelType.OPERATION);
