...
public class OpenSystemTypeScriptReduxGenerator extends DefaultCodegen implements CodegenConfig {
    private final Logger LOGGER = LoggerFactory.getLogger(OpenSystemTypeScriptReduxGenerator.class);
    ...
    public OpenSystemTypeScriptReduxGenerator() {
        super();
        ...
        outputFolder = "generated-code" + File.separator + "open-system-typescript-redux";
        embeddedTemplateDir = templateDir = "open-system-typescript-redux";
        ...
        cliOptions.add(new CliOption(OpenSystemTypeScriptReduxGenerator.FILE_CONTENT_DATA_TYPE, OpenSystemTypeScriptReduxGenerator.FILE_CONTENT_DATA_TYPE_DESC).defaultValue("Buffer"));
        cliOptions.add(new CliOption(OpenSystemTypeScriptReduxGenerator.USE_RXJS_SWITCH, OpenSystemTypeScriptReduxGenerator.USE_RXJS_SWITCH_DESC).defaultValue("false"));
        cliOptions.add(new CliOption(OpenSystemTypeScriptReduxGenerator.USE_OBJECT_PARAMS_SWITCH, OpenSystemTypeScriptReduxGenerator.USE_OBJECT_PARAMS_DESC).defaultValue("true"));
        cliOptions.add(new CliOption(OpenSystemTypeScriptReduxGenerator.USE_INVERSIFY_SWITCH, OpenSystemTypeScriptReduxGenerator.USE_INVERSIFY_SWITCH_DESC).defaultValue("true"));

        CliOption frameworkOption = new CliOption(OpenSystemTypeScriptReduxGenerator.FRAMEWORK_SWITCH, OpenSystemTypeScriptReduxGenerator.FRAMEWORK_SWITCH_DESC);
        for (String option: OpenSystemTypeScriptReduxGenerator.FRAMEWORKS) {
            frameworkOption.addEnum(option, option);
        }
        frameworkOption.defaultValue(FRAMEWORKS[0]);
        cliOptions.add(frameworkOption);

        CliOption platformOption = new CliOption(OpenSystemTypeScriptReduxGenerator.PLATFORM_SWITCH, OpenSystemTypeScriptReduxGenerator.PLATFORM_SWITCH_DESC);
        for (String option: OpenSystemTypeScriptReduxGenerator.PLATFORMS) {
   ...
   private void setSourceRoot() {
    ...
    private void addProducesInfo(ApiResponse inputResponse,
      OpenSystemTypeScriptReduxOperation codegenOperation) {
     ...
     */
    @Override
    public OpenSystemTypeScriptReduxOperation fromOperation(String path,
      String httpMethod,
      Operation operation,
      List<Server> servers) {
        ...
        OpenSystemTypeScriptReduxOperation op = OpenSystemTypeScriptReduxModelFactory.newInstance(OpenSystemTypeScriptReduxModelType.OPERATION);
   ...
   */
    ...
    public String getName() {
      return "open-system-typescript-redux";
    }
    ...
    public String toOperationId(String operationId) {
        ...
        if (isReservedWord(operationId)) {
            return escapeReservedWord(camelize(sanitizeName(operationId),
    ...
    public String getHelp() {
        return "Generates a TypeScript client library using RTK-Query API (Redux-Toolkit).";
    }
