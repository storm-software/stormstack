...
public class OpenSystemTypeScriptClientGenerator extends DefaultCodegen implements CodegenConfig {
  ...
  public static final String IS_BASE_LIBRARY = "isBaseLibrary";
    ...
    public OpenSystemTypeScriptClientGenerator() {
        ...
        CliOption platformOption = new CliOption(OpenSystemTypeScriptClientGenerator.PLATFORM_SWITCH, OpenSystemTypeScriptClientGenerator.PLATFORM_SWITCH_DESC);
        for (String option: OpenSystemTypeScriptClientGenerator.PLATFORMS) {
