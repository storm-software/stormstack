...
public class OpenSystemTypeScriptClientOperation extends CodegenOperation {
    public boolean isGetOperation = false;
    public boolean isSearchOperation = false;
    public boolean isUpdateOperation = false;
    public boolean isBaseOperation = false;

    public boolean isQueryOperation = false;
    public boolean isMutateOperation = false;

    public boolean isBaseLibrary = false;
    public String methodName;

    public List<String> reqParams = new ArrayList<String>();

    public boolean isGetOperation() {
        return vendorExtensions.containsKey("x-api-type") &&
        ((String) vendorExtensions.get("x-api-type"))
            .trim()
            .toLowerCase()
            .equals("get");
    }
    ...
    public boolean isSearchOperation() {
        return operationIdLowerCase.trim().toLowerCase().contains("search");
    }

    public boolean isUpdateOperation() {
        return operationIdLowerCase.trim().toLowerCase().contains("update");
    }

    public String methodName() {
        String[] nicknames = operationIdOriginal.split("_");
        if (nicknames.length > 1) {

        return nicknames[1].substring(0, 1).toLowerCase()
    ...
    public boolean isBaseOperation() {
        return operationIdLowerCase.trim().toLowerCase().equals("get") ||
            operationIdLowerCase.trim().toLowerCase().equals("search") ||
            operationIdLowerCase.trim().toLowerCase().equals("update");
    }
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("OpenSystemTypeScriptClientOperation{");
        ...
        sb.append(", isGetOperation='").append(isGetOperation).append('\'');
        sb.append(", isUpdateOperation='").append(isUpdateOperation).append('\'');
        sb.append(", isSearchOperation='").append(isSearchOperation).append('\'');
        sb.append(", isBaseOperation='").append(isBaseOperation).append('\'');
    ...
    public boolean equals(Object o) {
      if (this == o) return true;
        ...
        OpenSystemTypeScriptClientOperation that = (OpenSystemTypeScriptClientOperation) o;
        return hasAuthMethods == that.hasAuthMethods &&
                ...
                isGetOperation == that.isGetOperation &&
                isUpdateOperation == that.isUpdateOperation &&
                methodName == that.methodName &&
                isSearchOperation == that.isSearchOperation &&
                isBaseOperation == that.isBaseOperation &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(responseHeaders, hasAuthMethods, hasConsumes, hasProduces, hasParams, hasOptionalParams,
                ...
                hasErrorResponseObject, isGetOperation, isUpdateOperation, isBaseOperation, isSearchOperation, methodName);
    }
}
