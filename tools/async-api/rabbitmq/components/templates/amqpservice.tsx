...
public class AmqpService : IAmqpService
{
    ...
    public void ${pascalCase(publisher.operationId)}(${
        ...
        } message)
    {
        ...
        var channel = _channelPool.GetChannel("${pascalCase(
    ...
    ${consumers
      .map(
        (consumer: Consumer) => `public void ${pascalCase(
        ...
        )}()
    {
        ...
        consumer.Received += (_, ea) =>
        {
            ...
            _logger.Verbose("${pascalCase(
              consumer.messageType
            )} received, {@${pascalCase(consumer.messageType)}}", message);
            ...
            {
                _logger.Error(e, "Something went wrong trying to process message {@${pascalCase(
                  consumer.messageType
                )}},", message);
