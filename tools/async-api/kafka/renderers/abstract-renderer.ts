...
export abstract class AbstractRenderer<
  ...
  TGenerator extends AbstractGenerator<TOptions> = AbstractGenerator<TOptions>,
  TRendererModelType extends ConstrainedMetaModel = ConstrainedMetaModel
> {
  constructor(
    protected readonly options: TOptions,
    readonly generator: TGenerator,
    protected readonly presets: Array<[Preset, unknown]>,
    protected readonly model: TRendererModelType,
