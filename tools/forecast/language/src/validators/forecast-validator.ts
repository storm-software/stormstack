...
import type { ForecastServices } from "../forecast-module";
 ...
 */
export class ForecastValidationRegistry extends ValidationRegistry {
  constructor(services: ForecastServices) {
    super(services);
    const validator = services.validation.ForecastValidator;
    const checks: ValidationChecks<ForecastAstType> = {
...
export class ForecastValidator {
  constructor(protected readonly services: ForecastServices) {}
