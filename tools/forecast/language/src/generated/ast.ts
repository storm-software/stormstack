...
export function isAbstractDeclaration(
  item: unknown
): item is AbstractDeclaration {
  return reflection.isInstance(item, AbstractDeclaration);
}

export type AttributeName =
  | DataModelAttributeName
  | DataModelFieldAttributeName
  | InternalAttributeName;

export function isAttributeName(item: unknown): item is AttributeName {
  return (
    isDataModelAttributeName(item) ||
    isDataModelFieldAttributeName(item) ||
    isInternalAttributeName(item)
  );
}
...
export function isDataModelAttributeName(
  item: unknown
): item is DataModelAttributeName {
  return typeof item === "string";
}

export type DataModelFieldAttributeName = string;

export function isDataModelFieldAttributeName(
  item: unknown
): item is DataModelFieldAttributeName {
  return typeof item === "string";
}
...
export function isInternalAttributeName(
  item: unknown
): item is InternalAttributeName {
  return typeof item === "string";
}
...
export function isAttributeParamType(
  item: unknown
): item is AttributeParamType {
...
export function isDataModelAttribute(
  item: unknown
): item is DataModelAttribute {
...
export function isDataModelFieldAttribute(
  item: unknown
): item is DataModelFieldAttribute {
...
export function isDataModelFieldType(
  item: unknown
): item is DataModelFieldType {
...
export function isUnsupportedFieldType(
  item: unknown
): item is UnsupportedFieldType {
...
export class StormAstReflection extends AbstractAstReflection {
  getAllTypes(): string[] {
    return [
      "AbstractDeclaration",
      "ApiModel",
...
export const reflection = new StormAstReflection();
