...
export type AbstractDeclaration = ApiModel | Attribute | DataModel | DataSource | Enum | FunctionDecl | GeneratorDecl | Input | Interface | OperationGroup | Plugin;
...
export function isOperationGroupName(item: unknown): item is OperationGroupName {
...
export type ReferenceTarget = DataModelField | EnumField | FunctionParam | Operation;
...
export type RegularID = 'abstract' | 'attribute' | 'datasource' | 'enum' | 'in' | 'input' | 'interface' | 'model' | 'plugin' | 'sort' | 'type' | string;

export function isRegularID(item: unknown): item is RegularID {
    return item === 'model' || item === 'type' || item === 'input' || item === 'interface' || item === 'enum' || item === 'attribute' || item === 'datasource' || item === 'plugin' || item === 'abstract' || item === 'in' || item === 'sort' || (typeof item === 'string' && (/[_a-zA-Z][\w_]*/.test(item)));
}

export type TypeDeclaration = ApiModel | DataModel | Enum | Input | Interface | OperationGroup;
...
export interface ArrayExpr extends AstNode {
    readonly $container: Argument | ArrayExpr | AttributeArg | BinaryExpr | DataSourceField | FieldInitializer | FunctionDecl | GeneratorField | MemberAccessExpr | OperationInputParam | PluginField | UnaryExpr | UnsupportedFieldType;
...
export interface DataModelAttribute extends AstNode {
    readonly $container: ApiModel | DataModel | Enum | Input | Interface | OperationGroup;
...
export interface DataModelField extends AstNode {
    readonly $container: ApiModel | DataModel | Enum | FunctionDecl | Input | Interface | OperationGroup;
...
export function isOperationInputParam(item: unknown): item is OperationInputParam {
...
export class ForecastAstReflection extends AbstractAstReflection {

    getAllTypes(): string[] {
        return ['AbstractDeclaration', 'ApiModel', 'Argument', 'ArrayExpr', 'Attribute', 'AttributeArg', 'AttributeParam', 'AttributeParamType', 'BinaryExpr', 'DataModel', 'DataModelAttribute', 'DataModelField', 'DataModelFieldAttribute', 'DataModelFieldType', 'DataSource', 'DataSourceField', 'Enum', 'EnumField', 'Expression', 'FieldInitializer', 'FunctionDecl', 'FunctionParam', 'FunctionParamType', 'GeneratorDecl', 'GeneratorField', 'Input', 'Interface', 'InternalAttribute', 'InvocationExpr', 'LiteralExpr', 'MemberAccessExpr', 'Model', 'ModelImport', 'NullExpr', 'ObjectExpr', 'Operation', 'OperationGroup', 'OperationInputParam', 'Plugin', 'PluginField', 'ReferenceArg', 'ReferenceExpr', 'ReferenceTarget', 'ThisExpr', 'TypeDeclaration', 'UnaryExpr', 'UnsupportedFieldType'];
    }
...
export const reflection = new ForecastAstReflection();
