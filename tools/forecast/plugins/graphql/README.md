...
- [⚡ Storm - GraphQL API Plugin](#-storm---graphql-api-plugin)
...
Run `nx test tools-forecast-plugins-graphql` to execute the unit tests via [Jest](https://jestjs.io).
