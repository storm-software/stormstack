 ...
 */
export const TRANSACTION_FIELD_NAME = "storm_transaction";

/**
 * Auxiliary database field for building up policy check queries
 */
export const GUARD_FIELD_NAME = "storm_guard";
 ...
 */
export const PRISMA_TX_FLAG = "$__storm_tx";

/**
 * Field name for getting current enhancer
 */
export const PRISMA_PROXY_ENHANCER = "$__storm_enhancer";
