  ...
  return (
    <div className="h-screen overflow-hidden">
      ...
      <div className="grid grid-cols-8 xl:grid-cols-6">
        <div className="col-span-2 hidden h-screen overflow-auto border-r-2 border-gray-200  bg-white px-4 py-3 shadow-md sm:block xl:col-span-1">
          ...
          <div className="space-y-6">
            <div className="flex">
              <button
                type="button"
                className="flex w-full rounded-md border text-left shadow-sm"
                onClick={() => handleAllEventsAndServicesSelection()}>
                <div
                  className={classNames(
                    "bg-blue-500",
                    "flex h-full w-4 flex-shrink-0 items-center justify-center rounded-l-md text-sm font-medium text-white"
                  )}
                />
                <div
                  ...
                  <div className="flex h-full flex-col justify-between space-y-2 p-4 text-sm">
                    <div className="xl:text-md break-all text-xs font-bold text-gray-900 hover:text-gray-600">
                      All Events and Services
                    </div>
                    <div className="mt-2 hidden text-xs font-normal text-gray-500 xl:block ">
  ...
  return (
    <li className="flex">
      <button
        ...
        className={`flex w-full rounded-md border text-left shadow-sm ${border}`}>
        <div
          style={{
