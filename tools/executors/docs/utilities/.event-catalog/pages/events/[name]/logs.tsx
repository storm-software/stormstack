                          ...
                          <div className="relative pb-8">
                            ...
                            <div className="relative flex space-x-3">
                              <div>
                                <span
                                  className={classNames(
                                    "flex h-8 w-8 items-center justify-center rounded-full bg-blue-500 text-xs text-white ring-8 ring-white"
                                  )}>
                              ...
                              <div>
                                ...
                                <div className="py-4 text-right text-sm text-gray-500">
