...
export const OsSection = /*@__PURE__*/createReactComponent<JSX.OsSection, HTMLOsSectionElement>('os-section');
export const OsSelect = /*@__PURE__*/createReactComponent<JSX.OsSelect, HTMLOsSelectElement>('os-select');
export const OsTitle = /*@__PURE__*/createReactComponent<JSX.OsTitle, HTMLOsTitleElement>('os-title');
