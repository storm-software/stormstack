...
export class ReactionsApiRequestFactory extends APIRequestFactory {
     ...
     */
    public async addArticleReaction(id: string, type: 'like' | 'dislike' | 'happy' | 'sad' | 'laugh' | 'cry', userId: string, _options?: HttpConfiguration): Promise<RequestContext> {
        ...
        // Header Params
        requestContext.setHeaderParam("userId", ObjectSerializer.serialize(userId, "string", "", enumsMap, typeMap));
...
*/
     ...
     * @param userId The id of the current user sending the request
     */
    public async deleteArticleReaction(id: string, type: 'like' | 'dislike' | 'happy' | 'sad' | 'laugh' | 'cry', userId: string, _options?: HttpConfiguration): Promise<RequestContext> {
        const _config = _options || this.configuration;
        ...
        // verify required parameter 'userId' is not null or undefined
        if (userId === null || userId === undefined) {
            throw new RequiredError("ReactionsApi", "deleteArticleReaction", "userId");
        }
...
*/
     ...
     * @param userId The id of the current user sending the request
     */
    public async getArticleReaction(id: string, type: 'like' | 'dislike' | 'happy' | 'sad' | 'laugh' | 'cry', userId: string, _options?: HttpConfiguration): Promise<RequestContext> {
        const _config = _options || this.configuration;
...
*/
     ...
     * @param userId The id of the current user sending the request
     */
    public async getArticleReactions(id: string, userId: string, _options?: HttpConfiguration): Promise<RequestContext> {
        const _config = _options || this.configuration;
...
export class ReactionsApiResponseProcessor {
     ...
     */
     public async addArticleReaction(response: ResponseContext): Promise<UpdateSuccessResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: UpdateSuccessResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "UpdateSuccessResponse", "", enumsMap, typeMap
        ...
        if (isCodeInRange("401", response.httpStatusCode)) {
            const body: ProblemDetails = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "ProblemDetails", "", enumsMap, typeMap
            ) as ProblemDetails;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteArticleReaction(response: ResponseContext): Promise<UpdateSuccessResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: UpdateSuccessResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getArticleReaction(response: ResponseContext): Promise<GetArticleReaction200Response > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GetArticleReaction200Response = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "GetArticleReaction200Response", "", enumsMap, typeMap
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getArticleReactions(response: ResponseContext): Promise<GetArticleReactions200Response > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GetArticleReactions200Response = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "GetArticleReactions200Response", "", enumsMap, typeMap
