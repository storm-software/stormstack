  ...
  return (
    <div className="group flex flex-col items-center justify-center gap-1 p-5 text-center">
      ...
      <div className="flex w-fit flex-row items-center gap-1 text-center">
        ...
        <label className="text-center text-lg font-body-1 text-primary">
          {totalRating}
        </label>
        ...
        <Link className="hidden text-lg font-body-1 text-primary underline opacity-0 transition-opacity hover:text-hover-link-2 group-hover:block group-hover:opacity-100">
          {count} users
        </Link>
      </div>
    </div>
