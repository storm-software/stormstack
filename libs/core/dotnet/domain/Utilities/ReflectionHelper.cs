...
namespace OpenSystem.Core.Domain.Utilities
{
    public static class ReflectionHelper
    {
        ...
        public static Func<TInterfaceParameter, TResult> CompileConstructor<
            TInterfaceParameter,
            TResult
        >(Type typeOfTInterfaceParameterImpl, Type typeOfTResult)
        {
            ...
            if (constructor == null)
            {
                throw new ArgumentException(
                    $"Type {typeOfTResult.PrettyPrint()} doesn't have constructor of {typeOfTResult.Name}({typeOfTInterfaceParameterImpl.Name} typeOfTInterfaceParameterImpl)"
                );
            }
            ...
            var body = Expression.New(
                constructor,
                Expression.Convert(parameter, typeOfTInterfaceParameterImpl)
            );
        ...
        public static Func<T1, TResult> CompileConstructor<T1, TResult>()
        {
            ...
            {
                throw new ArgumentException(
                    $"Type {typeOfTResult.PrettyPrint()} doesn't have constructor of {typeOfTResult.Name}({typeOfT1.Name} arg1)"
                );
            }
        ...
        public static Func<object, TResult> CompileConstructor<TResult>(
            Type typeOfTResult,
            Type typeOfT1
        )
        {
            var constructorArgumentTypes = new[] { typeOfT1 };
            var parameters = constructorArgumentTypes
        ...
        public static Func<object, object, TResult> CompileConstructor<TResult>(
            Type typeOfTResult,
            Type typeOfT1,
            Type typeOfT2
        )
        {
            ...
            {
                throw new ArgumentException(
                    $"Type {typeOfTResult.PrettyPrint()} doesn't have constructor of {typeOfTResult.Name}({typeOfT1.Name} arg1,{typeOfT2.Name} arg2)"
                );
            }
        ...
        public static Func<object, object, object, TResult> CompileConstructor<TResult>(
            Type typeOfTResult,
            Type typeOfT1,
            Type typeOfT2,
            Type typeOfT3
        )
        {
            ...
            {
                throw new ArgumentException(
                    $"Type {typeOfTResult.PrettyPrint()} doesn't have constructor of {typeOfTResult.Name}({typeOfT1.Name} arg1,{typeOfT2.Name} arg2,{typeOfT3.Name} arg3)"
                );
            }
        ...
        public static Func<object, object, object, object, TResult> CompileConstructor<TResult>(
            Type typeOfTResult,
            Type typeOfT1,
            Type typeOfT2,
            Type typeOfT3,
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    $"Type {typeOfTResult.PrettyPrint()} doesn't have constructor of {typeOfTResult.Name}({typeOfT1.Name} arg1,{typeOfT2.Name} arg2,{typeOfT3.Name} arg3,{typeOfT4.Name} arg4)"
                );
            }
            ...
            var body = Expression.New(constructor, constructorArguments);
            var lambda = Expression.Lambda<Func<object, object, object, object, TResult>>(
                body,
                parameters
            );
            var method = lambda.Compile();
        ...
        public static Func<T1, T2, T3, T4, T5, TResult> CompileConstructor<
            T1,
            T2,
            T3,
            T4,
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    $"Type '{type.PrettyPrint()}' doesn't have a method called '{methodName}'"
                );
            }
