namespace OpenSystem.Core.Domain.Extensions
{
  ...
  public static class LockExtensions
  {
      ...
      public static void Locking(this object source,
        Action action)
      {
          lock (source)
          {
      ...
      /// <param name="source">Source object (to be locked)</param>
      /// <param name="action">Action (to be executed)</param>
      public static void Locking<T>(this T source,
      ...
      public static TResult Locking<TResult>(this object source,
        Func<TResult> func)
      {
          lock (source)
          {
      ...
      public static TResult Locking<T, TResult>(this T source,
