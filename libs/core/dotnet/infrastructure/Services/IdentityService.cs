...
namespace OpenSystem.Core.DotNet.Infrastructure.Service
{
  public class IdentityService : IIdentityService
  {
      ...
      public async Task<bool> IsInRoleAsync(string userId,
        string role)
      {
      ...
      public async Task<bool> AuthorizeAsync(string userId,
        string policyName)
      {
          var user = _userManager.Users.SingleOrDefault(u => u.Id == userId);
          ...
          var result = await _authorizationService.AuthorizeAsync(principal,
            policyName);
