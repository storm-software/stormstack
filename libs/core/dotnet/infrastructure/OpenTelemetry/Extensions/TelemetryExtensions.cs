...
namespace OpenSystem.Core.Infrastructure.OpenTelemetry.Extensions
{
    ...
    public class OpenTelemetryOptions
    {
        ...
        {
            get { return new OpenTelemetryOptions(); }
        }

        public Func<TracerProviderBuilder, TracerProviderBuilder> ConfigureTracerProvider
        {
            get;
            private set;
        } = p => p;
        ...
        public static OpenTelemetryOptions Build(
            Func<OpenTelemetryOptions, OpenTelemetryOptions> build
        ) => build(Default);

        public OpenTelemetryOptions Configure(
