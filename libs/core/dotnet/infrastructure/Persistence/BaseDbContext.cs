...
{
    public class BaseDbContext<TEntity, TEntityId> : DbContext, IBaseDbContext<TEntity, TEntityId>
        ...
        where TEntityId : EntityId
    {
        ...
        public BaseDbContext(ILoggerFactory loggerFactory, DbContextOptions options)
            : base(options)
        {
            ChangeTracker.QueryTrackingBehavior = QueryTrackingBehavior.NoTracking;
        ...
        {
            InnerSaveChangesAsync().GetAwaiter().GetResult();
        ...
        protected virtual void UpdateConcurrencyStamp(EntityEntry entry)
        {
            ...
            {
                Entry(concurrencyStamped).Property(x => x.ConcurrencyStamp).OriginalValue =
                    concurrencyStamped.ConcurrencyStamp;
                concurrencyStamped.ConcurrencyStamp = GuidUtility.Comb.CreateGuid().ToString("N");
            }
        }
        ...
        {
            if (
                entry.Entity is IConcurrencyStamped concurrencyStamped
