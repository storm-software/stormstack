...
namespace OpenSystem.Core.Infrastructure.Persistence.Extensions
{
    public static class MapperConfigurationExpressionExtensions
    {
        ...
        /// </summary>
        public static void UseEFCoreModel<TContext>(this IMapperConfigurationExpression config)
            where TContext : DbContext, new()
        {
            using (var context = new TContext())
            {
                config.UseEFCoreModel(context.Model);
            }
        }
        ...
        /// </summary>
        public static void UseEFCoreModel<TContext>(
            ...
            where TContext : DbContext
        {
            ...
            {
                config.UseEFCoreModel<TContext>(serviceProvider);
            }
        }
        ...
        /// </summary>
        public static void UseEFCoreModel(
            this IMapperConfigurationExpression config,
            IModel model
        ) =>
            config.SetGeneratePropertyMaps(
                new AutoMapper.GenerateEntityFrameworkCorePrimaryKeyPropertyMaps(model)
            );
    }
}
