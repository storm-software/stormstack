...
namespace OpenSystem.Core.Infrastructure.WebApi.Extensions
{
  ...
  {
    private static readonly MediaTypeHeaderValue _jsonMediaType = new(HttpContentTypeConstants.Json);
    ...
    public static bool AcceptsJson(this HttpRequest httpRequest) => Accepts(httpRequest, 
      _jsonMediaType);
    ...
    public static bool Accepts(this HttpRequest httpRequest, 
      string mediaType) =>
        Accepts(httpRequest, 
    ...
    public static async Task<string> GetRequestBodyAsync(this HttpRequest request)
    {
        ...
        var hasRequestBody = httpMethodsWithRequestBody.Any(x => 
          x.Equals(request.Method.ToUpper()));
    ...
    public static async Task WriteResponseAsync(this HttpContext context, 
      object body)
    {
        var bodyText = body.ToString();
        context.Response.ContentLength = bodyText != null 
    ...
    public static async Task WriteJsonResponseAsync(this HttpContext context, 
      int httpStatusCode, 
      string jsonString)
    {
        context.Response.StatusCode = httpStatusCode;
        context.Response.ContentType = HttpContentTypeConstants.Json;
        context.Response.ContentLength = jsonString != null 
          ? Encoding.UTF8.GetByteCount(jsonString) 
          : 0;
    ...
    /*public async Task WriteProblemDetailsAsync(this HttpContext context, 
