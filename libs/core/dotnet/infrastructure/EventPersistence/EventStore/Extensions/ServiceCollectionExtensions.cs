...
using OpenSystem.Core.Infrastructure.EventPersistence.EventStore.Settings;

namespace OpenSystem.Core.Infrastructure.EventPersistence.EventStore.Extensions
{
