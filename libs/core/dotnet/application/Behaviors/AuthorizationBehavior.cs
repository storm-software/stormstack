...
namespace OpenSystem.Core.Application.Behaviors
{
        ...
        where TRequest : MediatR.IRequest<TResponse>
    {
        ...
        )
        {
            ...
            var authorizeAttributes = new object[0]; // request.GetType().GetCustomAttributes<AuthorizeAttribute>();
            ...
            if (authorizeAttributes.Any())
            {
                ...
                if (authorizeAttributesWithRoles.Any())
                {
                    ...
                    foreach (
                        var roles in authorizeAttributesWithRoles.Select(a => a.Roles.Split(','))
                    )
                    {
