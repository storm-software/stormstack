...
namespace OpenSystem.Core.Application.ReadStores
{
        ...
        where TReadModel : class, IReadModel
    {
        ...
        private async Task<ReadModelEnvelope<TReadModel>> ApplyUpdatesAsync(
        ...
        )
        {
            ...
            return readModelEnvelope.AsModified(readModel, readModelVersion);
        }
        ...
        )
        {
            ...
            if (envelopeVersion.HasValue && expectedVersion != envelopeVersion)
            {
                ...
                if (expectedVersion < version)
                {
                    ...
                    return readModelEnvelope.AsUnmodified<TReadModel>();
                }
