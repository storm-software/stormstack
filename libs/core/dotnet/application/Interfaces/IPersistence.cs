...
namespace OpenSystem.Core.Application.Interfaces
{
    public interface IPersistence<TTo>
    {
        ...
        TTo InsertOrUpdate<TFrom>(TFrom from)
            where TFrom : class;
        ...
        Task<TTo> InsertOrUpdateAsync<TFrom>(
            TFrom from,
        ...
        Task<TTo> RemoveAsync<TFrom>(TFrom from, CancellationToken cancellationToken = default)
            where TFrom : class;
    }
}
