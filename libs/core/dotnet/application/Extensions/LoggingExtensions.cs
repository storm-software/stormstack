  ...
  public static class LoggingExtensions
  {
       private static readonly Action<ILogger, Exception> _unhandledException =
        ...
        public static void UnhandledException(this ILogger logger, 
          Exception exception)
        {
            _unhandledException(logger, 
              exception);
        }

        public static void ResponseStarted(this ILogger logger)
        {
            _responseStarted(logger, 
              null);
        }

        public static void ProblemDetailsFactoryException(this ILogger logger, 
          Exception exception)
        {
            _problemDetailsFactoryException(logger, 
              exception);
        }

        public static void IgnoredException(this ILogger logger, 
          Exception exception)
        {
            _ignoredException(logger, 
              exception);
        }
  }
}
