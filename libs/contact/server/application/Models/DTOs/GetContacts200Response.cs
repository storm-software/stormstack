...
{ 
    ...
    /// </summary>
    [DataContract]
    public class GetContacts200Response : IEquatable<GetContacts200Response>
    {
        /// <summary>
        ...
        public GetContacts200Response Copy(GetContacts200Response? copyTo)
        {
            if (copyTo == null)
              copyTo = new GetContacts200Response();
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GetContacts200Response)obj);
        }

        /// <summary>
        /// Returns true if GetContacts200Response instances are equal
        /// </summary>
        /// <param name="other">Instance of GetContacts200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetContacts200Response other)
        {
        ...
        public static bool operator ==(GetContacts200Response left, GetContacts200Response right)
        {
