...
{ 
    ...
    /// </summary>
    [DataContract]
    public class ContactDetailRecord : IEquatable<ContactDetailRecord>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactDetailRecord {\n");
        ...
        public ContactDetailRecord Copy(ContactDetailRecord? copyTo)
        {
            if (copyTo == null)
              copyTo = new ContactDetailRecord();

            copyTo.CompanyName = this.CompanyName;
            copyTo.Title = this.Title;
            copyTo.Reason = this.Reason;
            copyTo.Details = this.Details;
            copyTo.Url = this.Url;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ContactDetailRecord)obj);
        }

        /// <summary>
        /// Returns true if ContactDetailRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of ContactDetailRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactDetailRecord other)
        {
        ...
        public static bool operator ==(ContactDetailRecord left, ContactDetailRecord right)
        {
