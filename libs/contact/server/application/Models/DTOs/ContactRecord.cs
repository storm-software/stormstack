...
{ 
    ...
    /// </summary>
    [DataContract]
    public class ContactRecord : IEquatable<ContactRecord>
    {
        /// <summary>
        ...
        public ContactRecord Copy(ContactRecord? copyTo)
        {
            if (copyTo == null)
              copyTo = new ContactRecord();
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ContactRecord)obj);
        }

        /// <summary>
        /// Returns true if ContactRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of ContactRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactRecord other)
        {
        ...
        public static bool operator ==(ContactRecord left, ContactRecord right)
        {
