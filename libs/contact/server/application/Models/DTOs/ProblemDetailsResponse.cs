...
{ 
    ...
    /// </summary>
    [DataContract]
    public class ProblemDetailsResponse : IEquatable<ProblemDetailsResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ProblemDetailsResponse)obj);
        }
        ...
        public static bool operator ==(ProblemDetailsResponse left, ProblemDetailsResponse right)
        {
