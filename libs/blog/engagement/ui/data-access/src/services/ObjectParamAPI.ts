...
export abstract class AbstractObjectReactionsApi {
  ...
  public abstract addArticleReaction(
    param: req.ReactionsApiAddArticleReactionRequest,
  ...
  public abstract deleteArticleReaction(
    param: req.ReactionsApiDeleteArticleReactionRequest,
    options?: AbstractHttpConfiguration
  ): Promise<UpdateSuccessResponse>;
  ...
  public abstract getArticleReaction(
    param: req.ReactionsApiGetArticleReactionRequest,
    options?: AbstractHttpConfiguration
  ...
  public abstract getArticleReactions(
    param: req.ReactionsApiGetArticleReactionsRequest,
    options?: AbstractHttpConfiguration
