...
export const AddReactionRequestTypeEnum = {
  LIKE: "like" as AddReactionRequestTypeEnum,
  UNLIKE: "unlike" as AddReactionRequestTypeEnum,
  CRY: "cry" as AddReactionRequestTypeEnum,
  LAUGH: "laugh" as AddReactionRequestTypeEnum,
};
