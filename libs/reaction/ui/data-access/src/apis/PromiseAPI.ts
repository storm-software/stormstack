...
export class PromiseReactionsApi {
  ...
  public async addArticleReaction(
    ...
    let request: RequestContext = await this.requestFactory.addArticleReaction(
      id,
      type,
      userId,
      _options
  ...
  public async deleteArticleReaction(
    ...
    let request: RequestContext =
      await this.requestFactory.deleteArticleReaction(
        id,
        type,
        userId,
        _options
  ...
  public async getArticleReaction(
    ...
    let request: RequestContext = await this.requestFactory.getArticleReaction(
      id,
      type,
      userId,
      _options
  ...
  public async getArticleReactions(
    ...
    let request: RequestContext = await this.requestFactory.getArticleReactions(
      id,
      userId,
      _options
    );
