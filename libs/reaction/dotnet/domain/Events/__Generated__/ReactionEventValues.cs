...
namespace OpenSystem.Blog.Reaction.Application.Models
{
	...
	public partial class ReactionEventValues : global::Avro.Specific.ISpecificRecord
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse(@"{""type"":""record"",""name"":""ReactionEventValues"",""doc"":""The message details of a user's reaction to content in the OpenSystem application."",""namespace"":""OpenSystem.Blog.Reaction.Application.Models"",""fields"":[{""name"":""ContentId"",""type"":""string""},{""name"":""UserId"",""type"":""string""},{""name"":""Type"",""type"":{""type"":""enum"",""name"":""ReactionTypes"",""doc"":""The types of possible reactions a user could have to content."",""namespace"":""OpenSystem.Blog.Reaction.Application.Models"",""symbols"":[""Like"",""Dislike"",""Love"",""Happy"",""Sad"",""Laugh"",""Cry""]}},{""name"":""Count"",""default"":1,""type"":""int""}]}");
		...
		public virtual global::Avro.Schema Schema
		{
			get
			{
				return ReactionEventValues._SCHEMA;
			}
		}
