...
namespace OpenSystem.Reaction.Application.Models.DTOs
{
    ...
    /// </summary>
    [DataContract]
    public class UpdateReactionRequest : IEquatable<UpdateReactionRequest>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateReactionRequest {\n");
        ...
        public UpdateReactionRequest CopyTo(UpdateReactionRequest? copyTo)
        {
            if (copyTo == null)
                copyTo = new UpdateReactionRequest();
        ...
        public override bool Equals(object obj)
        {
            ...
            if (ReferenceEquals(this, obj))
                return true;
            return obj.GetType() == GetType() && Equals((UpdateReactionRequest)obj);
        }

        /// <summary>
        /// Returns true if UpdateReactionRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateReactionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateReactionRequest other)
        {
            if (other is null)
                return false;
...
#pragma warning disable 1591
        ...
        public static bool operator ==(UpdateReactionRequest left, UpdateReactionRequest right)
        {
