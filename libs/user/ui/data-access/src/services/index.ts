...
import {
  AbstractUsersApiRequestFactory,
  AbstractUsersApiResponseProcessor
} from "./UsersApiParser.service";
import {
  UsersApiRequestFactory,
  UsersApiResponseProcessor
} from "../parsers/UsersApiParser";
...
export class ApiServiceBinder {
  ...
  protected constructor(private container: interfaces.Container) {
    ...
    public bindAllApiServices() {
        ...
        this.container
          .bind(AbstractUsersApiRequestFactory)
          .to(UsersApiRequestFactory)
          .inSingletonScope();
        this.container
          .bind(AbstractUsersApiResponseProcessor)
          .to(UsersApiResponseProcessor)
          .inSingletonScope();

        this.container.bind(apiServices.AbstractObjectUsersApi).to(apis.ObjectUsersApi).inSingletonScope();
    }
}
